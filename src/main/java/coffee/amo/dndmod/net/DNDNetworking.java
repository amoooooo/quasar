...
public class DNDNetworking {
    ...
    public static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(
            new ResourceLocation("dndmod", "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void init() {
        CHANNEL.registerMessage(packetID++, CubeParticlePacket.class, CubeParticlePacket::encode, CubeParticlePacket::new, CubeParticlePacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
    }
